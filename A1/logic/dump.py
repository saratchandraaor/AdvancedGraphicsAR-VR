...
wall_coords= []
wall_width = window_width/10
wall_height = window_height/10
...
glTexImage2D(GL_TEXTURE, 0, GL_RGBA, image_w.width, image_w.height, 0, GL_RGBA, GL_UNSIGNED_BYTE, img_data_w)
...
#
glBindTexture(GL_TEXTURE, texture_w)
